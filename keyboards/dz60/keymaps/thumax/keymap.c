...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_iso(
        ...
        _______, _______, _______,                            XXXXXXX,                            _______, _______, _______, MO(3)
    ),
    // Navi
    [2] = LAYOUT_60_iso(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX,                            XXXXXXX, TG(2), XXXXXXX, XXXXXXX
    ),
    // Utils
    [3] = LAYOUT_60_iso(
